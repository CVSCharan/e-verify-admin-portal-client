...
export const metadata: Metadata = {
  ...
  description:
    "Secure login portal for E-Verify administrators. Access the certificate management system by Technotran Solutions.",
  keywords:
    "admin login, e-verify portal, certificate verification, technotran solutions",
  robots: "noindex, nofollow", // Admin pages shouldn't be indexed
  alternates: {
    canonical: "https://admin-portal.technotran.in/",
  },
};
