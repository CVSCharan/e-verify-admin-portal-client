...
const VendorsPage = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Vendor Management | E-Verify Portal | Technotran Solutions
        </title>
        <meta
          name="description"
          content="Administrative dashboard to manage vendor organizations in the E-Verify Portal certificate verification system."
        />
        <meta
          name="keywords"
          content="vendor management, organization administration, e-verify portal, certificate verification, technotran solutions"
        />
        <meta name="robots" content="noindex, nofollow" />
